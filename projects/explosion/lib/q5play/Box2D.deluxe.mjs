...
async function Box2D(moduleArg = {}) {
  moduleArg = {
...
async function createWasm() {
  ...
  /** @param {WebAssembly.Module=} module*/ function receiveInstance(instance, module) {
    ...
    registerTLSInit(wasmExports["ja"]);
...
var ___getTypeName, __embind_initialize_bindings, _pthread_self, _malloc, _free, __emscripten_tls_init, __emscripten_thread_init, __emscripten_thread_crashed, _emscripten_stack_get_end, _emscripten_stack_get_base, __emscripten_run_js_on_main_thread, __emscripten_thread_free_data, __emscripten_thread_exit, __emscripten_timeout, __emscripten_check_mailbox, _emscripten_stack_init, _emscripten_stack_set_limits, __emscripten_stack_restore, __emscripten_stack_alloc, _emscripten_stack_get_current, ___set_stack_limits, __indirect_function_table, wasmTable;

function assignWasmExports(wasmExports) {
  ___getTypeName = wasmExports["da"];
  __embind_initialize_bindings = wasmExports["ea"];
  _pthread_self = wasmExports["fa"];
  _malloc = Module["_malloc"] = wasmExports["ga"];
  _free = Module["_free"] = wasmExports["ha"];
  __emscripten_tls_init = wasmExports["ja"];
  __emscripten_thread_init = wasmExports["ka"];
  __emscripten_thread_crashed = wasmExports["la"];
  _emscripten_stack_get_end = wasmExports["ma"];
  _emscripten_stack_get_base = wasmExports["na"];
  __emscripten_run_js_on_main_thread = wasmExports["oa"];
  __emscripten_thread_free_data = wasmExports["pa"];
  __emscripten_thread_exit = wasmExports["qa"];
  __emscripten_timeout = wasmExports["ra"];
  __emscripten_check_mailbox = wasmExports["sa"];
  _emscripten_stack_init = wasmExports["ta"];
  _emscripten_stack_set_limits = wasmExports["ua"];
  ...
  ___set_stack_limits = Module["___set_stack_limits"] = wasmExports["ya"];
  __indirect_function_table = wasmTable = wasmExports["ia"];
}
...
function assignWasmImports() {
  wasmImports = {
    ...
    /** @export */ ba: __embind_register_class_class_function,
    ...
    /** @export */ o: __embind_register_enum_value,
    ...
    /** @export */ S: __emscripten_init_main_thread_js,
    ...
    /** @export */ D: __emscripten_thread_cleanup,
    /** @export */ R: __emscripten_thread_mailbox_await,
    /** @export */ V: __emscripten_thread_set_strongref,
    /** @export */ l: __emval_create_invoker,
    /** @export */ f: __emval_decref,
    /** @export */ y: __emval_get_global,
    /** @export */ v: __emval_get_property,
    /** @export */ n: __emval_incref,
    /** @export */ X: __emval_instanceof,
    /** @export */ k: __emval_invoke,
    /** @export */ p: __emval_new_array,
    /** @export */ u: __emval_new_cstring,
    /** @export */ aa: __emval_new_object,
    /** @export */ j: __emval_run_destructors,
    /** @export */ w: __emval_set_property,
    /** @export */ J: __setitimer_js,
    /** @export */ W: _clock_time_get,
    /** @export */ E: _emscripten_check_blocking_allowed,
    /** @export */ U: _emscripten_exit_with_live_runtime,
    /** @export */ x: _emscripten_get_now,
    /** @export */ K: _emscripten_num_logical_cores,
